...
<link href="{{ asset('dist/css/demo.min.css') }}" rel="stylesheet" />
    ...
    {{-- <link
      href="dist/css/tabler.min.css?1684106062&amp;_cacheOverride=1688508930740"
      rel="stylesheet"
    />
    <link
      href="./dist/css/tabler-flags.min.css?1684106062&amp;_cacheOverride=1688508930740"
      rel="stylesheet"
    />
    <link
      href="./dist/css/tabler-payments.min.css?1684106062&amp;_cacheOverride=1688508930740"
      rel="stylesheet"
    />
    <link
      href="./dist/css/tabler-vendors.min.css?1684106062&amp;_cacheOverride=1688508930740"
      rel="stylesheet"
    />
    <link
      href="./dist/css/demo.min.css?1684106062&amp;_cacheOverride=1688508930740"
      rel="stylesheet"
    /> --}}
  </head>
  <body>
            ...
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <span class="nav-link-title"> Player Operation</span>
                </a>
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="./player-list.html">
                        Player List
                      </a>
                      <a class="dropdown-item" href="./document-list.html">
                        Document List
                      </a>
                      <a class="dropdown-item" href="./fiction-risk.html">
                        Fiction Risk
                        <span
                      ...
                      <a class="dropdown-item" href="./big-wins.html">
                        Big Wins
                        <span
                          class="badge badge-sm bg-green-lt text-uppercase ms-auto"
                          >New</span
                      ...
                      <a class="dropdown-item" href="./player-types.html">
                        Player Types
                        <span
                          class="badge badge-sm bg-green-lt text-uppercase ms-auto"
                          >New</span
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <span class="nav-link-title"> Player Requests</span>
                </a>
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="./bonus-request.html">
                        Bonus Request
                      </a>
                      <a class="dropdown-item" href="./support-request.html">
                        Support Request
                      </a>
                      <a class="dropdown-item" href="./call-request.html">
                        Call Request
                      </a>
                      <a class="dropdown-item" href="./affiliate-request.html">
                        Affiliate Request
                      </a>
                      <a
                        class="dropdown-item"
                        href="./document-submission.html"
                      >
                        Document Submission
                      </a>
                    </div>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <span class="nav-link-title"> Financial Operation</span>
                </a>
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="./deposit-operation.html">
                        Deposit Operation
                      </a>
                      <a class="dropdown-item" href="./withdrawal-request.html">
                        Withdrawal Request
                      </a>
                      ...
                      <a class="dropdown-item" href="./payment-methods.html">
                        Payment Methods
                      </a>
                    </div>
                  </div>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <span class="nav-link-title"> System Report</span>
                </a>
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="./player-report.html">
                        Player Report
                      </a>
                      <a class="dropdown-item" href="./deposit-report.html">
                        Deposit Report
                      </a>
                      <a class="dropdown-item" href="./withdrawal-report.html">
                        Withdrawal Report
                      </a>
                      <a class="dropdown-item" href="./bonus-report.html">
                        Bonus Report
                      </a>
                      <a class="dropdown-item" href="./affiliate-report.html">
                        Affiliate Report
                      </a>
                    </div>
                  </div>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <span class="nav-link-title"> Provider Report</span>
                </a>
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="./casino-report.html">
                        Casino Report</a
                      >
                      <a class="dropdown-item" href="./slot-report.html">
                        Slot Report
                      </a>

                      <a class="dropdown-item" href="./sport-report.html">
                        Sport Report
                        <span
                          class="badge badge-sm bg-green-lt text-uppercase ms-auto"
                          >New</span
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <span class="nav-link-title"> Timeline Report</span>
                </a>
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a
                        class="dropdown-item"
                        href="./timeline-submission.html"
                      >
                        Timeline Submission</a
                      >
                      <a class="dropdown-item" href="./confirmed-timeline.html">
                        Confirmed Timeline
                      </a>
                    </div>
                  </div>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <span class="nav-link-title"> Operator Handling</span>
                </a>
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="./operator-list.html">
                        Operator List
                      </a>
                      <a class="dropdown-item" href="./operator-groups.html">
                        Operator Groups
                      </a>
                    </div>
                  </div>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <span class="nav-link-title"> Mirror Reflector</span>
                </a>
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="./blocking-order.html">
                        Blocking Order
                      </a>
                      <a class="dropdown-item" href="./nsdnscare.html">
                        NS DNS Care
                      </a>
                    </div>
                  </div>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <span class="nav-link-title">Bonus Engine</span>
                </a>
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="./bonus-list.html">
                        Bonus List
                      </a>
                      <a class="dropdown-item" href="./bonus-rules.html">
                        Bonus Rules
                      </a>
                    </div>
                  </div>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <span class="nav-link-title"> Content Moderation</span>
                </a>
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="./knowledge-pages.html">
                        Knowledge Pages
                      </a>
                      <a class="dropdown-item" href="./promotions.html">
                        Promotions
                      </a>
                      <a class="dropdown-item" href="./banners.html">
                        Banners
                        <span
                          class="badge badge-sm bg-green-lt text-uppercase ms-auto"
                          >New</span
                      ...
                      <a class="dropdown-item" href="./popups.html"> Popups </a>
                    </div>
                  </div>
                </div>
              </li>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="./site-visual.html">
                        Site Visual
                      </a>
                      <a class="dropdown-item" href="./menu-control.html">
                        Menu Control
                      </a>
                      <a class="dropdown-item" href="./footer-control.html">
                        Footer Control
                        <span
                          class="badge badge-sm bg-green-lt text-uppercase ms-auto"
                          >New</span
                      ...
                      <a class="dropdown-item" href="./social-network.html">
                        Social Network
                      </a>
                      <a class="dropdown-item" href="./login-form.html">
                        Login Form
                      </a>
                      <a class="dropdown-item" href="./registration-form.html">
                        Registration Form
                        <span
                          class="badge badge-sm bg-green-lt text-uppercase ms-auto"
                          >New</span
...
@endif
            ...
            <div class="col-12">
              <div class="row row-cards">
                <div class="col-6">
                  <div class="card">
                    <div class="card-body">
                      <h3 class="card-title">Comission Types</h3>
                      <p></p>
                ...
                <div class="col-6">
                  <div class="card">
                    <div class="card-body">
                      <h3 class="card-title">Network Types</h3>
                      <p></p>
                      <div class="progress progress-separated mb-3">
                        <div
                          class="progress-bar bg-primary"
                  ...
                  <div class="d-flex">
                    ...
                    <div class="me-2">
                      <select class="form-select">
                        <option value="1">10.000 transaction</option>
                        <option value="2">50.000 transaction</option>
                        <option value="2">100.000 transaction</option>
                      </select>
                    </div>
                  </div>
                </div>
            ...
            {{-- <div class="col">
              ...
              >
                <!-- Photo -->
                <div
                  class="img-responsive img-responsive-3x3 rounded border"
                  style="background-image: url(./static/photos/balham.png)"
                ></div>
              </a>
            </div> --}}
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body text-center py-4">
            ...
            <div class="text-muted">
              Do you really want to logout 1844 player? What you've done cannot
              be undone.
            </div>
          </div>
    ...
    <div
      ...
      aria-hidden="true"
    >
    {{-- <form method="post" action="{{ route('InsertAffliate') }}">
      @csrf
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="mb-3">
                  ...
                  <select name="players" id="" class="form-control" required>
                    <option value="OLatunde">OLatunde</option>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <select class="form-select" type="network_type" required>
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <input
                    ...
                    name="network_link"
                    class="form-control"
                    placeholder="www.instgram.com/network"
                  />
                </div>
              </div>
              <div class="col-lg-12">
