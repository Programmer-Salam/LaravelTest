<div>
            ...
            <div class="page-body">
              <div class="container-xl">
                <div class="row align-items-center">
                  <div class="col">
                    <!-- Page pre-title -->
                    <div class="page-pretitle">Affiliate Groups</div>
                    <h2 class="page-title">Comission Types</h2>
                  </div>
                ...
                <div class="mb-3 row">
                  <span wire:loading wire:target="createCommissionType" class="col-md-3 offset-md-5 text-primary loading-indicator">Loading...</span>
                </div>
          ...
          @endif 
                ...
                <div class="col-md-12 col-lg-12 mt-2">
                  <div class="card">
                    <table class="table card-table table-vcenter">
                      ...
                      <tbody>
                        @forelse ($AffiliateComissions as $AffiliateComission)
                        <tr>
                            <td>{{ $AffiliateComission->type_name }}</td>
                            <td>{{ $AffiliateComission->minimum_rate }}</td>
                            <td>{{ $AffiliateComission->maximum_rate }}</td>
                            <td>{{ $AffiliateComission->description }}</td>
                        </tr>
                    @empty
                        <tr>
                ...
                <div class="row align-items-center">
                  <div class="col">
                    <!-- Page pre-title -->
                    <div class="page-pretitle">Affiliate Groups</div>
                    <h2 class="page-title">Network Types</h2>
                  </div>
                  <div class="col-auto ms-auto">
                    <div class="btn-list">
                      <a
                ...
                <div class="col-md-12 col-lg-12 mt-2">
                  <div class="card">
                    <table class="table card-table table-vcenter">
                      ...
                      <tbody>
                        @forelse ($AffiliateNetworks as $AffiliateNetwork)
                        <tr>
                            <td>{{ $AffiliateNetwork->network }}</td>
                            <td>{{ $AffiliateNetwork->network_domain_type }}</td>
                            <td>{{ $AffiliateNetwork->network_domain }}</td>
                        </tr>
                    @empty
                        <tr>
        ...
        <div
          ...
          aria-hidden="true"
        >
    @include('livewire.affiliate-comission-form')
  </div>
  <div
  class="modal modal-blur fade"
  id="modal-report2"
  ...
  aria-hidden="true"
>
    @include('livewire.affiliate-networktype-form')
